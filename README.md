...
```sh
  ...
  git clone git@github.com:Tek2022/Finish-mobile_version.git
...
- GitHub: [@githubFentahun](https://github.com/Tek2022)
- Twitter: [@twitterFentahun](https://twitter.com/AddiseTeklu)
